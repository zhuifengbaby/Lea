...
namespace LeaRun.Application.Service.BaseManage
{
    ...
    /// 描 述：H_HouseNew
    /// </summary>
    public class H_HouseNewService : RepositoryFactory, H_HouseNewIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            var expression = LinqExtensions.True<H_HouseNewEntity>();
             ...
             if (!queryParam["SETime"].IsEmpty())
            {
             ...
             if (!queryParam["HH"].IsEmpty())
             {
                 string HH = queryParam["HH"].ToString();
                 expression = expression.And(t => t.HH == HH);
             }
        ...
        {
            return this.BaseRepository().FindEntity<H_HouseNewEntity>(keyValue);
        }
        /// <summary>
        /// 获取子表详细信息
        /// </summary>
        ...
        public void RemoveForm(string keyValue)
        {
            ...
            try
            {
                db.Delete<H_HouseNewEntity>(keyValue);
