...
namespace LeaRun.Application.Service.BaseManage
{
    ...
    /// 描 述：农村宅基地建房放样单
    /// </summary>
    public class Load_HomesteadLayoutFormService : RepositoryFactory, Load_HomesteadLayoutFormIService
    {
        #region 获取数据
        /// <summary>
        /// 获取列表
        ...
        {
            var expression = LinqExtensions.True<Load_HomesteadLayoutFormEntity>();
        ...
        {
            return this.BaseRepository().FindEntity<Load_HomesteadLayoutFormEntity>(keyValue);
        }
        #endregion
        ...
        public void RemoveForm(string keyValue)
        {
            ...
            try
            {
                db.Delete<Load_HomesteadLayoutFormEntity>(keyValue);
