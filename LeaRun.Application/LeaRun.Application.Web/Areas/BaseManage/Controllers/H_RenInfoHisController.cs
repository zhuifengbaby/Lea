...
namespace LeaRun.Application.Web.Areas.BaseManage.Controllers
{
    ...
    /// 描 述：H_RenInfoHis
    /// </summary>
    public class H_RenInfoHisController : MvcControllerBase
    {
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult H_RenInfoHisIndex()
        {
            return View();
        }

        [HttpGet]
        public ActionResult H_RenInfoHisIndex2()
        {
            return View();
        }
        /// <summary>
        ...
        /// <returns></returns>
        [HttpGet]
        public ActionResult H_RenInfoHisForm()
        {
            return View();
        }
        #endregion
        ...
        public ActionResult GetPageListJson(Pagination pagination, string queryJson)
        {
            ...
            var data = H_RenInfoHisbll.GetPageList(pagination, queryJson);
            var jsonData = new
            {
                rows = data,
        ...
        {
            var data = H_RenInfoHisbll.GetList(queryJson);
        ...
        {
            var data = H_RenInfoHisbll.GetEntity(keyValue);
            return ToJsonResult(data);
        }
        ...
        {
            H_RenInfoHisbll.RemoveForm(keyValue);
            return Success("删除成功。");
        }
        ...
        {
            H_RenInfoHisEntity rne = H_RenInfoHisbll.GetEntity(keyValue);
            ...
            H_RenInfoHisbll.SaveForm(keyValue, rne);
            return Success("审核成功。");
        }
        ...
        [ValidateAntiForgeryToken]
        [AjaxOnly]
        public ActionResult SaveForm(string keyValue, H_RenInfoHisEntity entity)
        {
            ...
            else
            {
                ...
                H_RenInfoHisbll.SaveForm(keyValue, entity);
                return Success("操作成功。");
            }
        }
        public ActionResult HuiForm(string keyValue)
        {
            H_RenInfoHisEntity rne = H_RenInfoHisbll.GetEntity(keyValue);
            H_RenInfoEntity entity = new H_RenInfoEntity();
            entity.Address = rne.Address;
